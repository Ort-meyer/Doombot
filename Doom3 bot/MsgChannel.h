...
public:
    ...
    idBitMsg				AppendMessageInfo(idBitMsg sendMessage, const int time, const idBitMsg &msg);
    ...
    bool			Process(int time, idBitMsg &msg, int &sequence);
    ...
    //	int AppendMessageInfo(idPort &port, const int time, const idBitMsg &msg);
